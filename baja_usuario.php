...
<html lang="es">
  ...
  <body class="container">
    ...
    <div class="alert alert-primary" role="alert">
        <h3 class="text-center fst-italic">Dar de baja un usuario</h3>
    </div>
    <br>
            ...
            <div class="col-6">
                ...
                <form action="baja_usuario_sql.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input readonly type="text" id="clave" name="clave" class="form-control" value="<?php echo $clave; ?>">
                    </div>    
                    <br>
                    <div class="form-group">
                        <label for="rol" style="color:blue" class="font-weight-bold">Perfil</label>
                        <input readonly type="text" id="rol" name="rol" class="form-control" value="<?php echo $rol; ?>">
                    </div> 
                    <br>
                    
                    <button type="submit" class="btn btn-primary container-fluid" name="boton" value=1>Dar de baja</button>
